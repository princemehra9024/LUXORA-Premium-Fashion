...
import { womenProducts, womenCategories, allProducts } from '@/data/products';
...
const WomenPage = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.women-feature-item',
  ...
  return (
    <div className={`min-h-screen theme-transition ${theme === 'dark' ? 'bg-[#050505]' : 'bg-[#fff5f5]'}`}>
      ...
      <section ref={heroRef} className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden border-b border-rose-100/10">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-rose-900/10 via-transparent to-black/40" />
        </div>
        ...
        <div className="relative z-10 w-full px-6 sm:px-8 lg:px-16 xl:px-24">
          <div ref={heroTextRef} className="max-w-4xl">
            <motion.div
              ...
              className="hero-text-item inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-500/20 border border-rose-500/30 mb-8"
            >
              <Crown className="w-4 h-4 text-rose-400" />
              <span className="text-sm text-rose-400 tracking-[0.2em] font-bold uppercase">The Ethereal Collection</span>
            </motion.div>
            ...
            >
              INFINITE <br />
              <span className="text-rose-500">GRACE</span> & POISE
            </h1>

            <p className={`hero-text-item text-xl max-w-xl mb-12 leading-relaxed ${
              theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
            }`}>
              Experience the convergence of timeless elegance and contemporary flair. 
              Designed for the woman who defines her own narrative.
            </p>
            ...
            <div className="hero-text-item flex flex-wrap gap-8 items-center">
              <Link to="/shop">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group flex items-center gap-3 px-10 py-5 bg-black text-white rounded-full font-black text-xs tracking-widest uppercase hover:bg-black/90 transition-all shadow-[0_20px_40px_rgba(244,63,94,0.15)]"
                >
                  Explore Studio
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </motion.button>
              </Link>
              <div className="flex items-center gap-4 text-xs font-black tracking-[0.2em] uppercase text-rose-500 cursor-pointer group">
                Summer Edit
                <div className="w-12 h-[1px] bg-rose-500 group-hover:w-24 transition-all" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 border-y border-rose-100/10 overflow-hidden">
        <Marquee 
          text="ETHEREAL • GRACE • POISE • ELEGANCE • TIMELESS • LUXURY • SOPHISTICATION" 
          speed={0.5} 
        />
      </section>
      ...
      <section className="py-32 px-6 sm:px-8 lg:px-16 xl:px-24">
         <div className="mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs font-black tracking-[0.3em] uppercase text-rose-500">Limited Masterpiece</span>
            </div>
            <h2 
              className={`text-5xl sm:text-6xl font-black ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
              style={{ fontFamily: 'Teko, sans-serif' }}
            >
              ARTISAN <span className="text-rose-500">HIGHLIGHT</span>
            </h2>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
             {specialProduct && (
                <PremiumProductCard 
                  ...
                  index={0} 
                  accentColor="rose"
                  onAddToCart={() => addToCart(specialProduct.id)}
                  onToggleWishlist={() => toggleWishlist(specialProduct.id)}
                  isInWishlist={wishlist.includes(specialProduct.id)}
                />
             )}
          </div>
      </section>
      ...
      <section className="pb-32 px-6 sm:px-8 lg:px-16 xl:px-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-16 h-[2px] bg-rose-500" />
              <span className="text-xs font-black tracking-[0.3em] uppercase text-rose-500">Style Segments</span>
            </div>
            <h2 
              className={`text-6xl sm:text-7xl font-black ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
              style={{ fontFamily: 'Teko, sans-serif' }}
            >
              WOMEN'S <span className="text-rose-500">UNIVERSE</span>
            </h2>
          </div>
          <p className={`max-w-md text-base leading-relaxed ${theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`}>
            ...
            unique philosophy in modern womenswear design.
          </p>
        </div>

        <div className="women-feature-grid grid grid-cols-1 md:grid-cols-4 grid-rows-2 h-[800px] gap-6">
          {/* Main Large Item */}
          <motion.div 
          ...
          >
            ...
            <div className="absolute bottom-16 left-16 right-16">
               <span className="inline-block px-5 py-2 bg-rose-500 text-white text-[10px] font-black tracking-widest uppercase rounded-full mb-8 shadow-xl">Prestige Edit</span>
               <h3 className="text-6xl font-black text-white uppercase mb-4" style={{ fontFamily: 'Teko, sans-serif' }}>{womenCategories[0]?.name || "Dresses"}</h3>
               <p className="text-gray-400 text-lg mb-10 max-w-sm">Exquisite fabrics draped into silhouettes that move with an almost mystical fluidity.</p>
          ...
          >
            ...
            <div className="absolute bottom-10 left-10">
              ...
              <ArrowRight className="w-6 h-6 text-rose-400/50 mt-2 transform -rotate-45 group-hover:rotate-0 transition-transform" />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute left-12 top-1/2 -translate-y-1/2">
               <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[10px] font-black tracking-widest text-rose-400 uppercase">Season Highlight</span>
               </div>
              <h3 className="text-4xl font-black text-white uppercase mb-2" style={{ fontFamily: 'Teko, sans-serif' }}>{womenCategories[3]?.name} COLLECTION</h3>
              <p className="text-white/60 text-xs tracking-[0.3em] font-bold uppercase">Modern Feminine Identity</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 sm:px-8 lg:px-16 xl:px-24">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <aside className="w-full lg:w-72 flex-shrink-0">
            <div className="sticky top-32 p-8 rounded-[3rem] border border-rose-100/10 bg-white/[0.02] backdrop-blur-xl">
              ...
              <div className="space-y-3 mb-12">
                ...
                {['All', ...womenCategories.map(c => c.name)].map((cat) => (
                  <button
                    key={cat}
                    ...
                    className={`group w-full flex items-center justify-between px-6 py-4 rounded-2xl transition-all font-bold text-xs tracking-widest uppercase border ${
                      selectedCategory === cat
                        ...
                        : theme === 'dark' 
                          ...
                          : 'border-rose-100 text-gray-700 hover:bg-rose-50'
                    }`}
                  >
                    {cat}
                    <div className={`w-1.5 h-1.5 rounded-full transition-all ${
                      selectedCategory === cat ? 'bg-white scale-150 shadow-[0_0_8px_white]' : 'bg-transparent group-hover:bg-rose-500/50'
                    }`} />
                  </button>
                ))}
              </div>
              ...
              <div className="mb-12 px-4">
                 ...
                 <input
                  ...
                  />
                  <div className="flex justify-between items-center text-[11px] font-black tracking-widest text-rose-500">
                ...
                <div className="px-4 mb-12">
                    ...
                    <div className="relative">
                        ...
                        className={`w-full appearance-none px-6 py-4 rounded-2xl border font-bold text-xs tracking-widest uppercase transition-all ${
                            theme === 'dark' ? 'bg-black/50 border-white/5 text-white' : 'bg-white border-rose-100 text-gray-900 shadow-md'
                        }`}
                        >
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-16 px-4">
              ...
              <div className={`hidden sm:flex items-center rounded-2xl border p-1 ${
                theme === 'dark' ? 'border-white/5 bg-white/[0.02]' : 'border-rose-100 bg-white'
              }`}>
                {[3, 4].map((col) => (
                  <button
                    key={col}
                    ...
                    className={`p-3 rounded-xl transition-all ${
                      columns === col
                        ...
                        : theme === 'dark' ? 'text-gray-600 hover:text-white' : 'text-gray-400 hover:text-rose-500'
                    }`}
                  >
            ...
            {filteredProducts.length === 0 && (
                <div className="flex flex-col items-center justify-center py-32 text-center">
                    ...
                    <h3 className="text-4xl font-black text-rose-500 uppercase mb-4" style={{ fontFamily: 'Teko, sans-serif' }}>No results within spectrum</h3>
                    <button 
                        onClick={() => { setSelectedCategory('All'); setPriceRange([0, 500]); }}
                        className="px-10 py-5 bg-rose-500 text-white rounded-full font-black text-xs tracking-widest uppercase hover:bg-rose-600 transition-all"
                    >
                        Reset Refinement
                    </button>
                </div>
      ...
      <section className="py-32 px-6 sm:px-8 lg:px-16 xl:px-24">
        <div className="relative h-[650px] rounded-[5rem] overflow-hidden border border-white/5 group shadow-2xl">
           ...
           <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-12">
              <Crown className="w-16 h-16 text-rose-500 mb-10 animate-pulse" />
              <h3 className="text-7xl sm:text-9xl font-black text-white uppercase leading-[0.85] mb-10" style={{ fontFamily: 'Teko, sans-serif' }}>
                 ETHEREAL <br /> PRESENCE
              </h3>
              <p className="text-white/60 text-xl max-w-2xl uppercase tracking-[0.3em] font-bold mb-14 drop-shadow-2xl">
                Transcending the ordinary. Curating a legacy of feminine sophistication.
              </p>
              <div className="flex gap-6">
                <button className="px-12 py-6 bg-rose-500 text-white rounded-full font-black text-xs tracking-widest uppercase hover:bg-rose-600 transition-all shadow-2xl">
                    View Studio Story
                </button>
